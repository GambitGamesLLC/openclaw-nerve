...
describe('splitToolCallMessage', () => {
  ...
  it('extracts upload manifest attachments from user transcript messages', () => {
    const msg: ChatMessage = {
      role: 'user',
      content: 'Please use these files.\n\n<nerve-upload-manifest>{"version":1,"attachments":[{"id":"att-upload","origin":"upload","mode":"inline","name":"small.png","mimeType":"image/png","sizeBytes":120000,"inline":{"encoding":"base64","base64":"","base64Bytes":98000,"compressed":true},"preparation":{"sourceMode":"inline","finalMode":"inline","outcome":"optimized_inline","reason":"Inline image stayed within context-safe budget.","originalMimeType":"image/png","originalSizeBytes":120000},"optimization":{"applied":true,"tempDerivative":true,"cleanupAfterSend":true,"original":{"path":"/workspace/.temp/nerve-uploads/2026/03/21/small.png","uri":"file:///workspace/.temp/nerve-uploads/2026/03/21/small.png","mimeType":"image/png","sizeBytes":120000,"width":1024,"height":768},"optimized":{"path":"/home/derrick/.cache/openclaw/nerve/optimized-uploads/small.webp","uri":"file:///home/derrick/.cache/openclaw/nerve/optimized-uploads/small.webp","mimeType":"image/webp","sizeBytes":64000,"width":1024,"height":768},"artifacts":[{"role":"canonical_staged_source","path":"/workspace/.temp/nerve-uploads/2026/03/21/small.png","uri":"file:///workspace/.temp/nerve-uploads/2026/03/21/small.png","mimeType":"image/png","sizeBytes":120000,"width":1024,"height":768},{"role":"optimized_derivative","path":"/home/derrick/.cache/openclaw/nerve/optimized-uploads/small.webp","uri":"file:///home/derrick/.cache/openclaw/nerve/optimized-uploads/small.webp","mimeType":"image/webp","sizeBytes":64000,"width":1024,"height":768}]},"policy":{"forwardToSubagents":false}},{"id":"att-path","origin":"server_path","mode":"file_reference","name":"capture.mov","mimeType":"video/quicktime","sizeBytes":8000000,"reference":{"kind":"local_path","path":"/workspace/capture.mov","uri":"file:///workspace/capture.mov"},"preparation":{"sourceMode":"file_reference","finalMode":"file_reference","outcome":"file_reference_ready","reason":"Sent as a validated workspace path.","originalMimeType":"video/quicktime","originalSizeBytes":8000000},"policy":{"forwardToSubagents":true}}]}</nerve-upload-manifest>',
    };
    const result = splitToolCallMessage(msg);
    expect(result).toHaveLength(1);
    ...
    expect(result[0].uploadAttachments?.[0].optimization?.artifacts).toEqual([
      expect.objectContaining({ role: 'canonical_staged_source', mimeType: 'image/png', sizeBytes: 120000 }),
      expect.objectContaining({ role: 'optimized_derivative', mimeType: 'image/webp', sizeBytes: 64000 }),
    ]);
