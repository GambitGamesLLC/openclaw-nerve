...
/**
 * Preserve explicit intermediate markers without inferring them from nearby tool
 * calls. Assistant text emitted between tool calls is still user-visible chat.
 */
